...
func (c *apiItemCaller) GetPrefix() string { return c.name }

func (c *apiItemCaller) Get() interface{} { return c }

func (c *apiItemCaller) Name() string { return c.name }
...
func (c *apiItemCaller) GetServiceURL() string { return c.serviceURL }
